...
<!-- Nota: Use tailwind por que queria ver como funciona jeje -->
    ...
    <div class="w-full flex justify-center items-center">
        <h1 class="flex items-center text-5xl font-extrabold dark:text-white"><span class="bg-purple-100 text-purple-800 text-2xl font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-purple-200 dark:text-purple-800 ml-2">Factura</span></h1>
    </div> <br>
    <div class="w-full flex justify-center items-center">
